...
condition_pair_names = {"Armstrong": ['name_armstrong_job_armstrong_58', "name_armstrong_job_rozado_47", "name_armstrong_job_wen_58", "name_armstrong_job_wang_30", "name_armstrong_job_karvonen_71", "name_armstrong_job_zollo_49", "name_armstrong_job_yin_47",],
    'Rozado': ['name_rozado_job_armstrong_58', "name_rozado_job_rozado_47", "name_rozado_job_wen_58", "name_rozado_job_wang_30", "name_rozado_job_karvonen_71", "name_rozado_job_zollo_49", "name_rozado_job_yin_47", ],
    'Wen': ['name_wen_job_armstrong_58', "name_wen_job_rozado_47", "name_wen_job_wen_58", "name_wen_job_wang_30", "name_wen_job_karvonen_71", "name_wen_job_zollo_49", "name_wen_job_yin_47", ],
    'Wang': ['name_wang_job_armstrong_58', "name_wang_job_rozado_47", "name_wang_job_wen_58", "name_wang_job_wang_30", "name_wang_job_karvonen_71", "name_wang_job_zollo_49", "name_wang_job_yin_47", ],
    'Gaeb': ['name_gaeb_job_armstrong_58', "name_gaeb_job_rozado_47", "name_gaeb_job_wen_58", "name_gaeb_job_wang_30", "name_gaeb_job_karvonen_71", "name_gaeb_job_zollo_49", "name_gaeb_job_yin_47", ],
    'Lippens': ['name_lippens_job_armstrong_58', "name_lippens_job_rozado_47", "name_lippens_job_wen_58", "name_lippens_job_wang_30", "name_lippens_job_karvonen_71", "name_lippens_job_zollo_49", "name_lippens_job_yin_47", ],
    'Seshadri': ['name_seshadri_job_armstrong_58', "name_seshadri_job_rozado_47", "name_seshadri_job_wen_58", "name_seshadri_job_wang_30", "name_seshadri_job_karvonen_71", "name_seshadri_job_zollo_49", "name_seshadri_job_yin_47", ], 
    'Karvonen': ['name_karvonen_job_armstrong_58', "name_karvonen_job_rozado_47", "name_karvonen_job_wen_58", "name_karvonen_job_wang_30", "name_karvonen_job_karvonen_71", "name_karvonen_job_zollo_49", "name_karvonen_job_yin_47", ],
    'Zollo': ['name_zollo_job_armstrong_58', "name_zollo_job_rozado_47", "name_zollo_job_wen_58", "name_zollo_job_wang_30", "name_zollo_job_karvonen_71", "name_zollo_job_zollo_49", "name_zollo_job_yin_47", ], 
    'Yin': ['name_yin_job_armstrong_58', "name_yin_job_rozado_47", "name_yin_job_wen_58", "name_yin_job_wang_30", "name_yin_job_karvonen_71", "name_yin_job_zollo_49", "name_yin_job_yin_47", ]
    }
...
for metric in ["regression_coefficients"]:
    for condition_pair_key in condition_pairs.keys():
        ...
        df1, df2, df3, df4, df5, df6, df7 = condition_pair
        ...
        # r8 = df8[df8["Metric"]==metric].iloc[0]
        # r9 = df9[df9["Metric"]==metric].iloc[0]
        # r10 = df10[df10["Metric"]==metric].iloc[0]
        ...
        if metric in condition_pair_ylims.keys():
            ...
            plt.ylim(0.5, 1.2)
        plt.title(f'{metric} for "Woman" ({args.sampling}, {condition_pair_key} Names, {args.analysis} {args.exp_framework} framework)')
        
        # Optional: rotate x labels if they wrap
        plt.xticks(rotation=90)
        plt.tight_layout()
        plt.savefig(f'results/figs/{args.exp_framework}/{args.model}/{metric}_sampling_{args.sampling}_analysis_{args.analysis}_{condition_pair_key}.png')
        plt.close()