...
for item in data:
    ...
    try:
        ...
        os.makedirs(f"/nlp/scr/nmeist/EvalDims/output_data/yin/together/relaunched_batch_outputs/{model}/", exist_ok=True)

        client.files.retrieve_content(id=batch.output_file_id, output=f"/nlp/scr/nmeist/EvalDims/output_data/yin/together/relaunched_batch_outputs/{model}/name_{name}_job_{job}_{batch_num}.jsonl")
